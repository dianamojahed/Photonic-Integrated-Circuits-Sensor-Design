...
load_file = "Slide7_waveguide_Si_air_1550nm" #lumerical filename without .lms or .fsp part!
...
df.to_excel(os.path.join(dir_output, load_file+"Si_air_1550_neff.xlsx"), na_rep='', columns=df.columns, header=True, index=False)
#%%
