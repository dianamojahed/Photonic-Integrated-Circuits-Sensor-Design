...
load_file = "Slide15_waveguide_SiN_water_1550nm" #lumerical filename without .lms or .fsp part!
...
w_min =1.3 #min waveguide difference
w_max = 2.4 #max waveguide difference
...
df.to_excel(os.path.join(dir_output, load_file+"SiN_water_1550_neff.xlsx"), na_rep='', columns=df.columns, header=True, index=False)
#%%
