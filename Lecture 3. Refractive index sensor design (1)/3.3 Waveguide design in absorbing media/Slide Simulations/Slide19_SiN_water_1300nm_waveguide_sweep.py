...
load_file = "Slide19_waveguide_SiN_water_1300nm" #lumerical filename without .lms or .fsp part!
...
w_min =1.0 #min waveguide difference
w_max = 2.3 #max waveguide difference
...
df.to_excel(os.path.join(dir_output, load_file+"SiN_water_1300_neff.xlsx"), na_rep='', columns=df.columns, header=True, index=False)
#%%
