...
load_file = "Slide10_waveguide_Si_air_1650nm" #lumerical filename without .lms or .fsp part!
...
w_max = 0.9 #max waveguide difference
...
df.to_excel(os.path.join(dir_output, load_file+"Si_air_1650_neff.xlsx"), na_rep='', columns=df.columns, header=True, index=False)
#%%
#p2 = px.line(df,x='w', y=df.columns[1:3])
#p2.write_image(os.path.join(dir_output, load_file+"_neff_1650nm.png"))
#p2.show()
